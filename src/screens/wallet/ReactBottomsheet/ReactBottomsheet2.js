...
import bottomSheet from './BottomSheet.scss';
...
var propTypes = {
  showBlockLayer: _propTypes2['default'].bool,
  visible: _propTypes2['default'].bool,
  className: _propTypes2['default'].string,
  onClose: _propTypes2['default'].func.isRequired,
  appendCancelBtn: _propTypes2['default'].bool,
...
var BottomSheet = (function (_React$Component) {
  ...
  _createClass(BottomSheet, [{
    ...
    value: function render() {
      ...
      var layer = this.props.showBlockLayer ? _react2['default'].createElement('div', { className: bottomSheet.bottomSheetBlockLayer, onClick: this.props.onClose }) : null;

      return _react2['default'].createElement(
        'div',
        { className: bottomSheet.bottomSheetWrapper + (this.props.className || '') + ' ' + (this.state.animationState || '') + ' ' + (this.state.isShow ? bottomSheet.shown : bottomSheet.hide) },
        layer,
        this.props.customLayout,
        _react2['default'].createElement(
          'div',
          { className: bottomSheet.bottomSheet },
          this.props.children,
          this.props.list && this.props.list.map(function (item, idx) {
            return _react2['default'].createElement(
              'button',
              { key: idx, className: bottomSheet.bottomSheetItem, onClick: item.handler },
              item.title
            );
          }),
          this.props.appendCancelBtn && (function () {
            return _react2['default'].createElement(
              'button',
              { className: bottomSheet.bottomSsheetItem + " " + bottomSheet.cancel, onClick: _this2.props.onClose },
              'cancel'
            );
          })()
        )
